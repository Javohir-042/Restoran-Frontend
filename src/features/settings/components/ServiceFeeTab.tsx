...
export const ServiceFeeTab = () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="border border-gray-200 dark:border-[#27272a]/60 rounded-2xl p-6 md:p-8 space-y-8 bg-white dark:bg-[#18181b] shadow-sm ring-1 ring-black/[0.02]">
                <div className="flex flex-col md:flex-row md:justify-between md:items-center pb-8 border-b border-gray-100 dark:border-[#27272a] gap-4">
                    <div>
                        <h3 className="text-base font-semibold text-gray-900 dark:text-[#fafafa]">{t("Xizmat haqi foizi")}</h3>
                        <p className="text-sm text-gray-500 dark:text-[#a1a1aa] mt-1.5">{t("Har bir buyurtmaga qo'shiladigan foiz miqdori")}</p>
                    </div>
                    <div className="flex items-center gap-3 relative">
                        <div className="relative">
                            <input
                                ...
                                className="w-24 px-4 py-2.5 bg-gray-50 dark:bg-[#27272a]/50/50 border border-gray-200 dark:border-[#27272a] rounded-xl focus:bg-white dark:bg-[#121212] dark:text-[#fafafa] focus:outline-none focus:ring-2 focus:ring-[#1a56db]/20 focus:border-[#1a56db] transition-all text-center font-semibold text-lg hover:bg-gray-50 dark:hover:bg-[#27272a] dark:bg-[#27272a]/50"
                            />
                            <span className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 dark:text-[#71717a] font-semibold">%</span>
                        </div>
                        {errors.percent && (
                ...
                <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                    <div>
                        <h3 className="text-base font-semibold text-gray-900 dark:text-[#fafafa]">{t("Avtomatik hisobga qo'shish")}</h3>
                        <p className="text-sm text-gray-500 dark:text-[#a1a1aa] mt-1.5">{t("Check chiqarilganda xizmat haqi avtomatik hisoblanadi")}</p>
                    </div>
                    <button
                        type="button"
                        role="switch"
