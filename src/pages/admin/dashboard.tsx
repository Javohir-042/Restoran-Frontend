    ...
    return (
        <div className="space-y-4 sm:space-y-6 pb-6 sm:pb-10">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <StatCard
                    icon={<DollarSign size={14} className="text-blue-600 sm:w-4 sm:h-4" />}
                    iconBg="bg-blue-50"
                ...
                />
                <StatCard
                    icon={<Receipt size={14} className="text-orange-600 sm:w-4 sm:h-4" />}
                    iconBg="bg-orange-50"
                    label="Open Bills"
                ...
                />
                <StatCard
                    icon={<BookOpen size={14} className="text-purple-600 sm:w-4 sm:h-4" />}
                    iconBg="bg-purple-50"
                    label="Menu Items"
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={chartData}>
                                ...
                                <Tooltip
                                    ...
                                    itemStyle={{ color: "#fff" }}
                                    formatter={(v: number) => [formatSom(v), "Revenue"]}
                                />
                                <Area
                                    type="monotone"
                                    dataKey="total"
